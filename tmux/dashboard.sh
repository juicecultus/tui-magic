#!/bin/bash
# Dashboard layout — split view with neofetch, btop, and cava/cmatrix
...
# Top-left: neofetch + shell
tmux send-keys -t "$SESSION" 'neofetch && echo "" && echo "Type commands here..."' Enter
